...
const strategyPoints = [
  ...
  },
  {
    ...
    text: "We engineer conversion paths. Every CTA and flow is optimized for the bottom line.",
    icon: "M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2",
    color: "rose",
  },
  {
    title: "Developer-Ready",
    text: "Figma components and documented specs ensure zero loss between vision and code.",
    icon: "M8 9l3 3-3 3m5 0h3",
    color: "indigo",
  },
  {
    title: "Future-Proof Systems",
    text: "Scalable systems that grow with you — no redesign friction as teams expand.",
